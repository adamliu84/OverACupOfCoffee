...
findMissingNum :: String -> Int
findMissingNum = findMissingNum' maxDigits
...
main :: IO ()
main = do
    print $ findMissingNum "596597598600601602"
    print $ findMissingNum "12346789"
    print $ findMissingNum "26272829313233"
    print $ findMissingNum "9293949596979899101"
    print $ findMissingNum "9294959697"
    print $ findMissingNum "99101102103104105"
    print $ findMissingNum "596597598600601602"
    print $ findMissingNum "989999009901990299049905"
    print $ findMissingNum "98999901990299039904"
    print $ findMissingNum "9998999910000100011000210004"
    print $ findMissingNum "9899101102"
